...
//        ImageUtils.gray("e:/abc.jpg", "e:/abc_gray.jpg");//测试OK
        ...
        // 5-给图片添加文字水印：
        // 方法一：
        ImageUtils.pressText("我是水印文字","/data/background.png","/data/background_pressText.png","宋体",Font.BOLD,Color.white,80, 0, 0, 0.5f);//测试OK
        // 方法二：
        ImageUtils.pressText2("我也是水印文字", "/data/background.png","/data/background_pressText2.png", "黑体", 36, Color.white, 80, 0, 0, 0.5f);//测试OK
...
//        ImageUtils.pressImage("e:/abc2.jpg", "e:/abc.jpg","e:/abc_pressImage.jpg", 0, 0, 0.5f);//测试OK
    ...
    public final static void scale(String srcImageFile, String result,
        ...
        try {
        	...
        	if(!file.exists()){
        		throw new IllegalArgumentException("not found file,srcImageFile="+srcImageFile);
        	}
